...
/* ===================================================================
   ...
   past a screen — the page below only needs $foods to exist.
     ...
     image  uploads/food/<name>.jpg. Missing files degrade to the
            ...
            photograph.
   =================================================================== */
/* The dishes now live in includes/food-data.php, so api/bud-context.php
   can read the same eight and Bud answers from the page's own content
   rather than from whatever it happens to know about Bicol food.

   The array is unchanged — same keys, same order — so everything below
   this line works exactly as it did. */
$foods = require __DIR__ . '/includes/food-data.php';
